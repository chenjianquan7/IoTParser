        ...
        try:
            ...
            if request:
                ...
                if not self._is_replay() and response:
                    ...
                    print(KB["task_queue"].qsize(),req._method,req._url,req._post_data)
                    # print(KB["task_queue"].queue[-1][0])
                    # print(KB["task_queue"].queue[-1][1].raw[:100])
                    # print(KB["task_queue"].queue[-1][2].raw[:100])
            else:
